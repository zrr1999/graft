...
本设计文档已按模块拆分到 `docs/design/`；完整形式化 kernel 见 [`docs/graft-kernel.lean`](./graft-kernel.lean)（唯一源，结构为核心模型 + 核心公理 + 核心定义 + TODO）。

| 模块 | 内容 | 文件 |
| --- | --- | --- |
| 对象模型 | §2.1–§2.4 State / Action / Application / Change | [design/model.md](./design/model.md) |
| 属性与证据 | §2.5–§2.6 properties.roto / Evidence | [design/property.md](./design/property.md) |
...
| 形式 kernel | Lean 核心模型 / 公理 / 定义 / TODO | [graft-kernel.lean](./graft-kernel.lean) |
